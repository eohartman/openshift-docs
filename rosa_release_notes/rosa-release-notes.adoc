...
* **Cluster efficiency improvement** Now, you can perform specific tasks to make clusters more efficient. You can cordon, undoron, and drain a specific node. For more information, see xref:../rosa_cluster_admin/rosa-working-with-nodes.adoc[Working with nodes].
